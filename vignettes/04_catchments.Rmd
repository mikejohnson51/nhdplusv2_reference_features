...
# This catchment processing script takes in a set of NHDPlus catchment polygons and process them to remove any internal boundaries and small island polygons. It then returns a cleaned sf dataframe with only single valid polygon geometries. 
